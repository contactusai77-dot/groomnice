...
def send_booking_confirmation(phone: str, name: str) -> None:
    send_sms_raw(
        phone,
        f"Hi {name}! Your grooming appointment is confirmed. Note: cancellations under 24h incur a $25 fee. See you soon! 🐾",
    )
